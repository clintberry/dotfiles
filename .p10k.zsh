# Generated by Powerlevel10k configuration wizard on 2019-12-28 at 16:09 MST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 10605.
# Wizard options: nerdfont-complete + powerline, small icons, classic, dark, time,
# slanted separators, slanted heads, slanted tails, 2 lines, solid, full frame, compact,
# few icons, fluent, transient_prompt, instant_prompt=off.
